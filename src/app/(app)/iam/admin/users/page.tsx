...
export const metadata: Metadata = {
  title: "Admin · Users",
  description: "Manage operators, invites, and sessions (Afenda administrators).",
...
export default async function AdminUsersPage({
  ...
  const session = await requireFreshAdminSession("/iam/admin/users");
...
function buildAdminHref({
  ...
  return (query ? `/iam/admin/users?${query}` : "/iam/admin/users") as Route;
}
