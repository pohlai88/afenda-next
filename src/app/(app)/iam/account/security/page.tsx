...
export const metadata: Metadata = {
  ...
  description: "Sessions, passkeys, password, and account recovery for your Afenda operator identity.",
...
export default async function AccountSecurityPage({
  ...
  const session = await requireFreshVerifiedEmailSession("/iam/account/security");
