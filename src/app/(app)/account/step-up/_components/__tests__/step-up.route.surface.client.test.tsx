...
import { StepUpSurface } from "@/app/(app)/account/step-up/_components/step-up.route.surface.client";
...
describe("step-up route surface", () => {
  ...
  it("routes password step-up through the dedicated two-factor continuation when required", async () => {
    ...
    expect(locationAssignMock).toHaveBeenCalledWith(
      "/account/step-up/two-factor?callbackUrl=%2Fadmin%2Fusers&methods=totp",
    );
  });
});
