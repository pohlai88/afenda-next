 ...
 * @afenda-description Catalog search synced to ?q= for shareable filtered Interface Lab lists.
 */
"use client";
...
type InterfaceLabCatalogToolbarProps = {
  /** Accessible label for the search field. */
  "aria-label": string;
};

export function InterfaceLabCatalogToolbar(props: InterfaceLabCatalogToolbarProps) {
