 ...
 * @afenda-description Auto-generated registry preview for app-meter — edit scripts/interface-lab.registry-preview-snippet.automation.ts then run pnpm interface-lab:codegen
 */
"use client";
