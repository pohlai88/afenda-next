 ...
 * @afenda-description Static declaration registry and shared footer data for public declaration routes.
 */
...
} from "@/components/ui-blocks/declaration-shell/declaration-shell.types.shared";
import {
...
export type DeclarationSlug = (typeof declarationSlugs)[number];

export { declarationFooterIdentity, declarationFooterLinks };

const declarationLastUpdatedLabel = trustSurfaceLastUpdatedLabel;
const declarationStatusNote =
  "Placeholder declaration content for product implementation. Legal and commercial review should finalize wording before production launch.";

const privacyChannels = [
  publicTrustOwnerRoutes.privacy,
  {
    label: "Operational support",
    value: publicTrustOwnerRoutes.support.value,
    href: publicTrustOwnerRoutes.support.href,
    detail:
...
const securityChannels = [
  publicTrustOwnerRoutes.security,
  {
    label: "Operational support",
    value: publicTrustOwnerRoutes.support.value,
    href: publicTrustOwnerRoutes.support.href,
...
const supportChannels = [
  publicTrustOwnerRoutes.support,
  {
    label: "Privacy route",
    value: publicTrustOwnerRoutes.privacy.value,
    href: publicTrustOwnerRoutes.privacy.href,
    detail:
      "Use when a support issue includes personal data, notices, or regional privacy rights.",
  },
  {
    label: "Security route",
    value: publicTrustOwnerRoutes.security.value,
    href: publicTrustOwnerRoutes.security.href,
    detail:
...
export const declarationDocuments = {
  privacy: {
    ...
    description:
      "Afenda describes what personal data may be collected on its public and product surfaces, why that data is processed, how long it is retained, and which contact routes apply to Malaysia-established operations serving Southeast Asia.",
    eyebrow: "Malaysia-established privacy baseline",
    summary:
      "Afenda turns operational work into traceable records. This notice explains how personal data connected to those records, declarations, and public routes is handled.",
    sections: [
      {
        id: "identity",
        title: "Company identity and scope",
        body: [
          "Afenda is operated by [Legal Entity Name] (Company No. [Company Registration Number]), a company incorporated in Malaysia and serving business customers across Southeast Asia.",
          "This notice applies to the public website, public declaration routes, business enquiry channels, and product interactions that refer to this notice. Product-specific contractual terms or customer-controlled notices may add more detail where the implementation requires it.",
        ],
      },
      {
        id: "collection",
        ...
        body: [
          "Afenda may collect business contact details, company details, support correspondence, implementation notes, device and browser data, and product telemetry needed to operate, secure, and improve the service.",
          "Where a customer uses Afenda inside operational workflows, the customer remains responsible for determining what business or personal data enters those workflows and whether that data is appropriate for the intended use.",
        ],
        bullets: [
          "Business identity data such as names, role titles, company names, work emails, and work phone numbers.",
          "Operational data such as request details, support context, implementation notes, audit timestamps, and system-origin metadata.",
          "Technical data such as IP address, browser type, device characteristics, log events, authentication records, and session integrity signals.",
        ],
      },
      {
        id: "purposes",
        ...
        body: [
          ...
          "Afenda does not treat collected data as decorative marketing exhaust. The purpose of collection should remain tied to communication, service delivery, security, traceability, or legally required retention.",
        ],
        bullets: [
      ...
      },
      {
        ...
        body: [
          "Afenda may disclose data to carefully selected infrastructure, hosting, analytics, authentication, communications, and support providers where that is required to operate the service or respond to a legitimate request.",
          "Afenda expects those providers to act under appropriate confidentiality, security, and processing controls. Customers may request additional subprocessor or contractual information through the support and trust routes listed on this page.",
        ],
      },
      {
        id: "retention",
        ...
        body: [
          ...
          "Because Afenda serves Southeast Asia and uses modern infrastructure providers, some data may be stored or accessed outside Malaysia. Where that occurs, Afenda expects equivalent contractual and security controls to travel with the data.",
        ],
      },
      {
        id: "rights",
        ...
        body: [
          "Individuals and organisations may contact Afenda to ask about applicable access, correction, withdrawal, objection, or deletion routes, subject to the relevant legal and contractual limits.",
          "Afenda uses role-based contact channels so requests can be triaged into the right operational queue without losing context.",
        ],
      },
    ],
    relatedLinks: buildRelatedLinks("/privacy"),
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Afenda may update, suspend, or refine public content, evaluation posture, and declaration wording to keep the public surface accurate, safe, and aligned with the underlying product.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "Commercial, contractual, or route-boundary questions should be sent through the support route first so Afenda can direct them to the correct internal owner.",
        ],
      },
    ],
    relatedLinks: buildRelatedLinks("/terms"),
  ...
  security: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The exact production stack, geographic footprint, and processing path may vary by implementation. Enterprise buyers who need more detail should use the trust route on this page.",
        ],
      },
      {
        id: "access",
      ...
      },
      {
        ...
        body: [
          "Security questions, suspected vulnerabilities, or trust review requests should be sent to security@[domain]. Include enough context for Afenda to reproduce the issue, understand severity, and assign the correct owner.",
          "Afenda publishes a separate disclosure route at /security/disclosure so scope, safe harbor, and expected report format are explicit instead of implied.",
        ],
      },
      {
        id: "trust-contact",
    ...
    relatedLinks: buildRelatedLinks("/security", [securityDisclosureLink]),
  ...
  "security/disclosure": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Send reports to security@[domain]. Use support@[domain] only when the issue is inseparable from a live operational incident or customer rollout that already sits in the support queue.",
    ...
    relatedLinks: buildRelatedLinks("/security/disclosure"),
    contactChannels: securityChannels,
    statusNote: declarationStatusNote,
    lastUpdatedLabel: declarationLastUpdatedLabel,
  },
  support: {
    ...
    sections: [
      {
        ...
        body: [
          "Use support@[domain] for public product questions, implementation routing, declaration follow-up, and operational issues that do not belong in the privacy or security queues.",
      ...
      },
      {
        ...
        body: [
          "Use privacy@[domain] when the issue is about personal data, privacy notices, or rights requests. Use security@[domain] when the issue is about a vulnerability, trust review, or security-sensitive event.",
    ...
    relatedLinks: buildRelatedLinks("/support", [trustRouteLink]),
...
export function buildDeclarationMetadata(
  document: DeclarationDocumentDefinition,
): Metadata {
  const url = `/${document.slug}`;
