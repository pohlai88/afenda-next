...
export type InterfaceStudioComponentDetailWorkspaceProps = {
  previewLabel: string;
...
export function InterfaceStudioComponentDetailWorkspace({
  previewLabel,
  previewDescription,
  previewSurface,
  manifestExcerpt,
  anatomy = [],
}: InterfaceStudioComponentDetailWorkspaceProps) {
...
function UsagePanel({ excerpt }: { excerpt: InterfaceStudioManifestExcerpt }) {
  return (
...
function A11yPanel({ excerpt }: { excerpt: InterfaceStudioManifestExcerpt }) {
  return (
