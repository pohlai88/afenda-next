 ...
 * @afenda-description Auto-generated registry preview for app-tag-group — edit scripts/interface-studio.registry-preview-snippet.automation.ts then run pnpm interface-studio:codegen
 */
"use client";
