 ...
 * @afenda-description Auto-generated registry preview for app-popover — edit scripts/interface-studio.registry-preview-snippet.automation.ts then run pnpm interface-studio:codegen
 */
"use client";
