 ...
 * @afenda-description Curated Interface Studio entries outside the ui governance component registry.
 */
import type { InterfaceStudioItem } from "./interface-studio.types";

export const interfaceLabStaticItems: InterfaceStudioItem[] = [
  {
