...
import { WorkbenchInspector } from "@/features/workbench/components/erp-workbench.inspector.panel.client";
import {
  APPROVED_PRIMITIVE_ITEMS,
  getWorkbenchItemsByCategory,
  WORKBENCH_ITEMS,
} from "@/features/workbench/erp-workbench.catalog.registry.workbench";
